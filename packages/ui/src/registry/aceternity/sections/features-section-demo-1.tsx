...
export const aceternityFeaturesSectionDemo1Meta: RegistryItemMeta = {
	provider: "aceternity",
	kind: "section",
	id: "aceternity/section/features-section-demo-1",
	name: "features-section-demo-1",
	title: "Features Section Demo 1",
	categories: ["features"],
	tags: ["grid", "cards"],
	source: {
		registryUrl: "https://ui.aceternity.com/registry/features-section-demo-1.json",
		docsUrl: "https://ui.aceternity.com/components/features-section-demo-1",
	},
};

export function FeaturesSectionDemo1(): JSX.Element {
	return (
		<div className="py-20 lg:py-40">
			<div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 md:gap-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
...
export function Grid({ pattern, size }: { pattern?: number[][]; size?: number }): JSX.Element {
	const p =
		pattern ??
		([
			[7, 1],
