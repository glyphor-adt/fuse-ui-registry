  ...
  return (
    ...
    >
      <a href={product.link} className="block group-hover/product:shadow-2xl">
        {/* Using <img> to keep this component framework-agnostic. */}
        <img
...
export const aceternityHeroParallaxMeta = {
  id: "aceternity/ui/hero-parallax",
  provider: "aceternity",
  kind: "ui",
  name: "hero-parallax",
  title: "Hero Parallax",
  categories: ["hero"],
  tags: ["animation", "parallax", "scroll"],
  source: {
